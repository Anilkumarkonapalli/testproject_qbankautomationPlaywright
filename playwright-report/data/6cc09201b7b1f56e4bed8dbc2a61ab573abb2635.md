...
Call log:
  - waiting for locator('input[name="username"], input[id="username"], input[placeholder*="username" i], input[type="text"]').first() to be visible
    47 × locator resolved to hidden <input type="text" id="qb-corporate-id" ng-model="companyId" placeholder="Company ID" ng-hide="mainCtrl.isPersonalBanking" class="qb-signin-input ng-pristine ng-untouched ng-valid ng-empty ng-hide"/>
